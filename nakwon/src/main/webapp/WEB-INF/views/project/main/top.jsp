...
<div class="topdiv">
<ul class="topul">
<li class="topli"><a href="#" onclick="location.href='http://localhost:8031/introduce'" >소개</a></li>
<li class="topli"><a href="#" onclick="location.href='http://localhost:8031/courseMenu'">메뉴</a></li>
