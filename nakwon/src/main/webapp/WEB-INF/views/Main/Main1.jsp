...
<style type="text/css">
	body {background-color: #FFE4B5; font-size:11pt; padding:0; margin:0; text-align: center;	}
...
<body>
		<div class="banner">
			<ul>
				<li><img src="resources/Main1img/K-Food.jpg" width="580" height="420px"></li>
				<li><img src="resources/Main1img/Jangdokdae.jpg" width="580" height="420px"></li>
				<li><img src="resources/Main1img/Hanok.jpg" width="580" height="420px"></li>
			</ul>
		</div>
	</body>
</html>